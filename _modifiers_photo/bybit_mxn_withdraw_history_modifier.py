"""
Bybit MXN Withdraw History Screenshot Generator

Generates withdrawal history screenshots for Bybit with MXN (Mexican Peso) currency.
...
def render_bybit_mxn_withdraw_history(
    ...
    template_path: str = "templates/bybit_mxn_withdraw_history.png",
    output_path: str = "output/result.png"
) -> str:
    """
    Render Bybit MXN withdrawal history screenshot with 6 transactions.
