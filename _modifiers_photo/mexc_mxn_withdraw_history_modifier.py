"""
MEXC MXN Withdraw History Screenshot Generator

Generates withdrawal history screenshots for MEXC with MXN (Mexican Peso) currency.
...
def render_mexc_mxn_withdraw_history(
    tran_1: str,
    tran_2: str,
    tran_3: str,
    tran_4: str,
    ...
    template_path: str = "templates/mexc_mxn_withdraw_history.png",
    output_path: str = "output/result.png"
) -> str:
    """
    Render MEXC MXN withdrawal history screenshot with 4 transactions.

    Args:
        tran_1: Transaction 1 amount (e.g., "1,234.56")
    ...
    # Currency suffix for MXN (business logic: MXN remains unchanged)
    currency = " MXN"
