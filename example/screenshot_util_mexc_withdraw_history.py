...
def execute(tran_1, tran_2, tran_3, tran_4, winning_sum, persa_bank, lead_bank, persa_number, lead_number, time_in_description_1, time_in_description_2, country_type, input_naming, output_naming):
    fonts_regular = "fonts/blinkmacsystemfont-regular.ttf"
    if country_type == "VED":
        country_type = "Bs"
    if country_type == "ECU":
        country_type = "USD"
    ...
    editor.execute(fs, output_naming, output_naming, time_in_description_1, (416, 845), text_color=white, font_family=fonts_regular)
    editor.execute(fs, output_naming, output_naming, time_in_description_1, (416, 1010), text_color=white, font_family=fonts_regular)
    editor.execute(fs, output_naming, output_naming, time_in_description_1, (416, 1177), text_color=white, font_family=fonts_regular)
    editor.execute(fs, output_naming, output_naming, time_in_description_1, (416, 1340), text_color=white, font_family=fonts_regular)
    editor.execute(fs, output_naming, output_naming, time_in_description_1, (416, 1504), text_color=white, font_family=fonts_regular)
    editor.execute(fs, output_naming, output_naming, time_in_description_1, (416, 1666), text_color=white, font_family=fonts_regular)
...
if __name__ == "__main__":
    execute("12421", "234",  "234", "234", "234", "234", "Rewfwef Fsdfsdfd", "423423432", "MXN", "SCREENSHOT/MXN_MEXC_WITHDRAW_HISTORY.png", "output/MXN_MEXC_WITHDRAW_HISTORY.png")
